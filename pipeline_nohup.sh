...
python script_mdl_cell.py --cells $cell_inflam --num_epochs 60 --batch_size 1 --learning_rate 0.001 --num_params 32 --epoch_check 15
python script_mdl_cell.py --cells $cell_eosin --num_epochs 60 --batch_size 1 --learning_rate 0.001 --num_params 32 --epoch_chec 15
